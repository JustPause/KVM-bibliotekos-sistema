...
class IsKlaveturosSkaitytuvo(wx.Panel):
    def __init__(
        ...
        input_katalogas_layout.Add(
            self.staticText2, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5
        )
