...
ats_array = [
    ...
    {
        "Autorius": "Ziedonis, Imants (1933-2013)",
        "Pavadinimas": "Spalvotosios pasakos",
        "Metai": "2006",
        "isbn": "995543578x",
    },
    {"Autorius": "---", "Pavadinimas": "---", "Metai": "---", "isbn": "998614359x"},
    {
        "Autorius": "Pietaris, Vincas (1850-1902)",
        "Pavadinimas": "Lapės gyvenimas ir mirtis",
        "Metai": "1996",
        "isbn": "998659703x",
    },
    {"Autorius": "---", "Pavadinimas": "---", "Metai": "---", "isbn": "KVM251027025"},
    {
        "Autorius": "Hauff, Wilhelm (1802-1827)",
        "Pavadinimas": "Pasakos",
        "Metai": "1993",
        "isbn": "5790007279",
    },
    {
        "Autorius": "",
        "Pavadinimas": "Saliamono žiedas",
        "Metai": "1991",
        "isbn": "5899425733",
    },
    {
        "Autorius": "",
        "Pavadinimas": "Žemė ir jos gėrybės",
        "Metai": "1992",
        "isbn": "5899500190",
    },
    ...
    {
        "Autorius": "",
        "Pavadinimas": "Vilkas ir septyni ožiukai ir kitos pasakos",
        "Metai": "2003",
        "isbn": "9955061030",
    },
    {
        "Autorius": "Zanini, Giuseppe",
    ...
    {
        "Autorius": "Knister",
        "Pavadinimas": "Ragana Lilė tampa sekle",
        "Metai": "2005",
        "isbn": "9955088699",
    },
    {
        "Pavadinimas": "Mėnraštis „Aušra“",
        "Metai": "2023",
        "Autorius": "",
        "isbn": "9786094253515",
    },
    ...
    def test_IBibliotekosPaieska(self):
        ...
        with open(self.tmpOutput, "r", newline="", encoding="utf-8") as f:
            ...
            for index, row in enumerate(rows):
                ...
                self.assertEqual(
                    row.get("Pavadinimas"), ats_array[index].get("Pavadinimas")
                )
